...
import cn.ufunny.game.libs.cache.support.annotation.AbstractImmutableValuesCacheSupport;
 ...
 * @param <V>
 */
public abstract class DefaultLocalLinkedValuesCacheSupport<K extends Comparable<K>,T,V> extends AbstractImmutableValuesCacheSupport<K,T, V> {

	private  TreeMap<K, HashMap<T, V>> cache = Maps.newTreeMap();
